...
static inline void transfer_YUV101010_to_RGB8(unsigned char *(*output),
	unsigned char *input)
{
	int r, g, b;
	...
	*(*output)++ = (unsigned char)(((input[0] & 0xc000) >> 8) +
		((input[1] & 0xe000) >> 10) + ((input[2] & 0xe000) >> 13));
}
...
static inline void transfer_YUV101010_to_BGR565(unsigned char *(*output), unsigned char *input)
{
	...
	*(uint16_t*)(*output) = (b & 0xf800) |
		((g & 0xfc00) >> 5) | ((r & 0xf800) >> 11);
	(*output) += 2;
}

static inline void transfer_YUV101010_to_RGB565(unsigned char *(*output),
	unsigned char *input)
{
	int r, g, b;
	...
	*(uint16_t*)(*output) = (r & 0xf800) |
		((g & 0xfc00) >> 5) | ((b & 0xf800) >> 11);
	(*output) += 2;
}

static inline void transfer_YUV101010_to_BGR888(unsigned char *(*output),
	unsigned char *input)
{
	int r, g, b;
...
static inline void transfer_YUV101010_to_BGR8888(unsigned char *(*output),
	unsigned char *input)
{
	int r, g, b;
...
static inline void transfer_YUV101010_to_YUV888(unsigned char *(*output),
	unsigned char *input)
{
	READ_YUV101010
...
static inline void transfer_YUV101010_to_YUVA8888(unsigned char *(*output),
	unsigned char *input)
{
	READ_YUV101010
...
static inline void transfer_YUV101010_to_YUV161616(uint16_t *(*output),
	unsigned char *input)
{
	READ_YUV101010
...
static inline void transfer_YUV101010_to_YUVA16161616(uint16_t *(*output),
	unsigned char *input)
{
	READ_YUV101010
...
static inline void transfer_YUV101010_to_RGB888(unsigned char *(*output),
	unsigned char *input)
{
	int r, g, b;
...
static inline void transfer_YUV101010_to_RGBA8888(unsigned char *(*output),
	unsigned char *input)
{
	int r, g, b;
...
static inline void transfer_YUV101010_to_RGB161616(uint16_t *(*output),
	unsigned char *input)
{
	int r, g, b;
...
static inline void transfer_YUV101010_to_RGBA16161616(uint16_t *(*output),
	unsigned char *input)
{
	int r, g, b;
...
static inline void transfer_VYU888_to_RGB8(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_VYU888_to_BGR565(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_VYU888_to_RGB565(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_VYU888_to_BGR888(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_VYU888_to_BGR8888(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_VYU888_to_RGB888(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_VYU888_to_RGBA8888(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_VYU888_to_RGB161616(uint16_t *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_VYU888_to_RGBA16161616(uint16_t *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_VYU888_to_RGB_FLOAT(float *(*output),
	unsigned char *input)
{
	float y;
	int u, v;
...
static inline void transfer_VYU888_to_RGBA_FLOAT(float *(*output),
	unsigned char *input)
{
	float y;
	int u, v;
...
static inline void transfer_VYU888_to_YUV888(unsigned char *(*output),
	unsigned char *input)
{
	(*output)[0] = input[1];
	(*output)[1] = input[2];
...
static inline void transfer_VYU888_to_YUVA8888(unsigned char *(*output),
	unsigned char *input)
{
	(*output)[0] = input[1];
	(*output)[1] = input[2];
...
static inline void transfer_VYU888_to_YUV161616(uint16_t *(*output),
	unsigned char *input)
{
...
static inline void transfer_VYU888_to_YUVA16161616(uint16_t *(*output),
	unsigned char *input)
{
	(*output)[0] = ((int)input[1]) << 8;
	(*output)[1] = ((int)input[2]) << 8;
...
static inline void transfer_UYVA8888_to_RGB8(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_UYVA8888_to_BGR565(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_UYVA8888_to_RGB565(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_UYVA8888_to_BGR888(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_UYVA8888_to_BGR8888(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_UYVA8888_to_RGB888(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_UYVA8888_to_RGBA8888(unsigned char *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_UYVA8888_to_RGB161616(uint16_t *(*output),
	unsigned char *input)
{
	int y, u, v;
	int r, g, b;
...
static inline void transfer_UYVA8888_to_RGBA_FLOAT(float *(*output),
	unsigned char *input)
{
	float y, a;
	int u, v;
...
static inline void transfer_UYVA8888_to_YUV888(unsigned char *(*output),
	unsigned char *input)
{
	int a, anti_a;
...
static inline void transfer_UYVA8888_to_YUVA8888(unsigned char *(*output),
	unsigned char *input)
{
	(*output)[0] = input[1];
	(*output)[1] = input[0];
...
static inline void transfer_UYVA8888_to_YUV161616(uint16_t *(*output),
	unsigned char *input)
{
	int a, anti_a;
...
static inline void transfer_UYVA8888_to_YUVA16161616(uint16_t *(*output),
	unsigned char *input)
{
	(*output)[0] = input[1] << 8;
	(*output)[1] = input[0] << 8;
