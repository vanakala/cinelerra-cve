...
static void	pcm_test_bits_8  (char *filename, int filetype, int hash) ;
static void	pcm_test_bits_16 (char *filename, int filetype, int hash) ;
static void	pcm_test_bits_24 (char *filename, int filetype, int hash) ;
static void	pcm_test_bits_32 (char *filename, int filetype, int hash) ;
...
static void
pcm_test_bits_8  (char *filename, int filetype, int hash)
{	SNDFILE		*file ;
	SF_INFO		sfinfo ;
...
static void
pcm_test_bits_16 (char *filename, int filetype, int hash)
{	SNDFILE		*file ;
	SF_INFO		sfinfo ;
	int			k, items, zero_count ;
	short		*short_out, *short_in ;
...
static void
pcm_test_bits_24 (char *filename, int filetype, int hash)
{	SNDFILE		*file ;
	SF_INFO		sfinfo ;
	int			k, items, zero_count ;
	short		*short_out, *short_in ;
...
static void
pcm_test_bits_32 (char *filename, int filetype, int hash)
{	SNDFILE		*file ;
	SF_INFO		sfinfo ;
	int			k, items, zero_count ;
	short		*short_out, *short_in ;
