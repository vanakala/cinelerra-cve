...
/* frame-based prediction */
				{
				if(stwtop < 2)
					recon(video, video->oldrefframe, 0,
						video->newframe, 0,
				...
				if(stwbot < 2)
					recon(video, video->oldrefframe, 1, 
						video->newframe, 1,
						video->coded_picture_width, 
						video->coded_picture_width << 1, 
						WIDTH, 8, bx, by,
...
/* field-based prediction */
				if(stwtop < 2)
					recon(video, predframe,mv_field_sel[0][0],
						video->newframe,0,
						video->coded_picture_width << 1,
						video->coded_picture_width << 1,
						WIDTH, 16, bx, by,
...
/* determine which frame to use for lower half prediction */
					...
					recon(video, predframe, mv_field_sel[1][0], 
						video->newframe, 0, 
						video->coded_picture_width << 1,
						video->coded_picture_width << 1, 
						WIDTH, 8, bx, by+8, 
...
/* predict from field of same parity */
				recon(video, video->oldrefframe, currentfield, 
					video->newframe, 0, 
					video->coded_picture_width << 1,
					video->coded_picture_width << 1,
					WIDTH, 16, bx, by,
...
/* predict from field of opposite parity */
				recon(video, predframe, !currentfield, 
					video->newframe, 0, 
					video->coded_picture_width << 1, 
					video->coded_picture_width << 1, 
					WIDTH, 16, bx, by, 
...
/* frame-based prediction */
				if(stwtop < 2)
					recon(video, video->refframe, 0,
					video->newframe, 0,
					video->coded_picture_width,
					video->coded_picture_width << 1, WIDTH, 8, bx, by, 
					PMV[0][1][0], PMV[0][1][1], stwtop);

				if(stwbot < 2)
					recon(video, video->refframe, 1,
						video->newframe, 1,
						video->coded_picture_width,
						video->coded_picture_width << 1,
						WIDTH, 8, bx, by,
...
/* field-based prediction */
				recon(video, video->refframe, 
					mv_field_sel[0][1], video->newframe, 0,
					video->coded_picture_width << 1,
					video->coded_picture_width << 1,
					WIDTH, 16, bx, by,
					PMV[0][1][0], PMV[0][1][1], stwtop);
			...
			else if(motion_type==MC_16X8)
			{
				...
				recon(video, video->refframe, 
					mv_field_sel[1][1], video->newframe, 0,
					video->coded_picture_width << 1,
					video->coded_picture_width << 1,
					WIDTH, 8, bx, by+8,
