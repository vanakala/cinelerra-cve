...
int FileAVI::set_video_position(long x)
{
#ifdef USE_AVIFILE
...
int FileAVI::read_samples(double *buffer, long len)
{
#ifdef USE_AVIFILE
...
long FileAVI::compressed_frame_size()
{
	int result = 0;
	return result;
}
...
int FileAVI::write_samples(double **buffer, long len)
{
	return 0;
}
