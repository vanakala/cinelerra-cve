...
PLUGIN_THREAD_OBJECT(LinearizeMain, LinearizeThread, LinearizeWindow)
...
LinearizeWindow::LinearizeWindow(LinearizeMain *client, int x, int y)
...
int LinearizeWindow::create_objects()
{
	int x = 10, y = 10;
	...
	y += max_text->get_h() + 10;
	x = 10;
	add_tool(automatic = new LinearizeAuto(client, x, y));
	...
	add_tool(new LinearizeColorPicker(client, this, x, y));
...
void LinearizeWindow::update_histogram()
{
...
WINDOW_CLOSE_EVENT(LinearizeWindow)

MaxSlider::MaxSlider(LinearizeMain *client, 
	LinearizeWindow *gui, 
	int x, 
	int y,
	int w)
...
MaxText::MaxText(LinearizeMain *client,
	LinearizeWindow *gui,
	int x,
	int y,
	int w)
...
GammaSlider::GammaSlider(LinearizeMain *client, 
	LinearizeWindow *gui, 
	int x, 
	int y,
	int w)
...
GammaText::GammaText(LinearizeMain *client,
	LinearizeWindow *gui,
	int x,
	int y,
	int w)
...
LinearizeAuto::LinearizeAuto(LinearizeMain *client, int x, int y)
 : BC_CheckBox(x, 
 	y, 
...
int LinearizeAuto::handle_event()
{
...
LinearizeColorPicker::LinearizeColorPicker(LinearizeMain *plugin, 
	LinearizeWindow *gui, 
	int x, 
	int y)
...
int LinearizeColorPicker::handle_event()
{
