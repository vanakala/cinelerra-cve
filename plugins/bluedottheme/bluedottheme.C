...
// VWindow
	...
	BC_WindowBase::get_resources()->xmeter_images = new_image_set(5,
		"xmeter_normal.png",
		"xmeter_green.png",
		"xmeter_red.png",
		"xmeter_yellow.png",
	...
	BC_WindowBase::get_resources()->ymeter_images = new_image_set(5,
		"ymeter_normal.png",
		"ymeter_green.png",
		"ymeter_red.png",
		"ymeter_yellow.png",
...
void BlueDotTheme::get_mwindow_sizes(MWindowGUI *gui, int w, int h)
{
	...
	mclock_x = 20;
	mclock_y = mbuttons_y + mbuttons_h + CWINDOW_METER_MARGIN + 2;
	mclock_w = clock_bg->get_w() - 72;
...
void BlueDotTheme::build_patches()
{
