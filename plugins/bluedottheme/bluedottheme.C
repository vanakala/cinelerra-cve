...
// Length of buttons and color tabs
	...
	resources->menu_highlighted_fontcolor = DDBLUE;
...
// This buttons miss a bit. May need to be improved
	...
	new_button("magnifyS.png", "editpanelW_up.png", "editpanelW_hi.png",
		"editpanelW_dn.png", "magnify_button");
	...
	new_button("wrench.png", "editpanelW_up.png", "editpanelW_hi.png",
		"editpanelW_dn.png", "wrench");
...
// MIHA: COPIED FROM DEFAULT THEME M2<<
	...
	new_toggle("camera.png", cpanel_up, cpanel_hi,
		cpanel_checked, cpanel_dn, cpanel_checkedhi, "camera");
	new_toggle("crop.png", cpanel_up, cpanel_hi,
		cpanel_checked, cpanel_dn, cpanel_checkedhi, "crop");
	new_toggle("eyedrop.png", cpanel_up, cpanel_hi,
		cpanel_checked, cpanel_dn, cpanel_checkedhi, "eyedrop");
	new_toggle("magnify.png", cpanel_up, cpanel_hi,
		cpanel_checked, cpanel_dn, cpanel_checkedhi, "magnify");
	new_toggle("mask.png", cpanel_up, cpanel_hi,
		cpanel_checked, cpanel_dn, cpanel_checkedhi, "mask");
	new_toggle("ruler.png", cpanel_up, cpanel_hi,
		cpanel_checked, cpanel_dn, cpanel_checkedhi, "ruler");
...
// labels
	resources->label_images = new_image_set(5, "radial_up.png",
		"radial_uphi.png", "radial_checked.png",
		"radial_down.png", "radial_checkedhi.png");

	resources->audiovideo_color = DKGREY;
// clock font
	resources->medium_7segment =  new_image_set(20,
		"black_0.png", "black_1.png", "black_2.png",
		"black_3.png", "black_4.png", "black_5.png",
		"black_6.png", "black_7.png", "black_8.png",
		"black_9.png", "black_colon.png", "black_period.png",
...
// Status bar at the very bottom of the screen.
	...
	mstatus_progress_y = mstatus_h -
		BC_WindowBase::get_resources()->progress_images[0]->get_h();
...
#define MBUTTONS_RIGHTEDGE 290 + 11 + 2*30 + 11 + 2*30 + 11 + 14*30
	gui->draw_3segmenth(mbuttons_x, mbuttons_y,
		MBUTTONS_RIGHTEDGE, get_image("mbutton_left"), 0);
	gui->draw_3segmenth(mbuttons_x + MBUTTONS_RIGHTEDGE, mbuttons_y,
		mbuttons_w - 500, get_image("mbutton_right"));

	gui->draw_vframe(get_image("panel_divider"),
		mbuttons_x + 290 + 5, mbuttons_y - 1);

	gui->draw_vframe(get_image("panel_divider"),
		mbuttons_x + 290 + 11 + 30 * 2 + 5, mbuttons_y - 1);
...
// Clock (here the background of the clock is drawn)
	gui->draw_3segmenth(0, mbuttons_y + get_image("mbutton_left")->get_h(),
...
void BlueDotTheme::draw_cwindow_bg(CWindowGUI *gui)
{
	...
	gui->draw_3segmenth(0, ccomposite_h, button_division,
		get_image("cbuttons_left"));
	...
	if(edlsession->cwindow_meter)
	{
		...
		gui->draw_9segment(cmeter_x - CWINDOW_METER_MARGIN, 0,
			...
			mainsession->cwindow_h, get_image("cmeter_bg"));
	}
	else
	{
		gui->draw_3segmenth(button_division, ccomposite_h,
...
void BlueDotTheme::draw_vwindow_bg(VWindowGUI *gui)
{
	...
	if(edlsession->vwindow_meter)
	{
		...
		gui->draw_9segment(vmeter_x - VWINDOW_METER_MARGIN, 0,
			...
			mainsession->vwindow_h, get_image("vmeter_bg"));
	}
	else
	{
		gui->draw_3segmenth(button_division, vcanvas_h,
...
{
	gui->draw_9segment(0, 0, gui->get_w(),
		gui->get_h() - 40, get_image("preferences_bg"));
}
