...
int DenoiseFFTEffect::has_pts_api() { return 1; }
...
void DenoiseFFTEffect::update_gui()
{
	...
	{
		load_configuration();
		thread->window->lock_window("DenoiseFFTEffect::update_gui");
...
{
	KeyFrame *prev_keyframe = prev_keyframe_pts(get_source_position());
